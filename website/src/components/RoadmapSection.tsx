...
const roadmap: RoadmapPhase[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "Dynamic S-Box key-schedule generation", completed: true },
      { text: "HMAC-ANCH authentication mode support", completed: true },
      { text: "Language bindings: JS/WASM or Rust ports", completed: true },
    ],
  },
  {
    version: "v1.0",
    ...
    color: "var(--anch-green)",
    items: [
      { text: "Full public framework production release", completed: true },
      { text: "Complete developer SDK stable release", completed: true },
    ],
  },
];
